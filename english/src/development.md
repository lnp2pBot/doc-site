...
Anyone is welcome to contribute to [lnp2pBot](https://t.me/lnp2pBot). If you're looking for somewhere to start contributing, check out the [good first issue](https://github.com/grunch/p2plnbot/issues?q=is%3Aopen+is%3Aissue+label%3A"good+first+issue") list.

## Communication Channels

Most communication about [lnp2pBot](https://t.me/lnp2pBot) happens on the main [Telegram group](https://t.me/lnp2pbotHelp). Discussion about code changes happens in GitHub issues and pull requests.

## Contributor Workflow

All [lnp2pBot](https://t.me/lnp2pBot) contributors submit changes via pull requests. The workflow is as follows:
